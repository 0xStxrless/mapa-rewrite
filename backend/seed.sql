...
-- Pins
INSERT INTO pins (title, description, lat, lng, category) VALUES
  ('Dworzec Główny',       'Główny węzeł komunikacyjny, dużo bezdomnych wieczorami', 54.3571, 18.6444, 'Hotspot'),
  ('Noclegownia Wzgórze',  'Schronisko z 40 miejscami, czynne od 18:00',             54.3520, 18.6380, 'Shelter'),
  ('Kuchnia Społeczna',    'Ciepły posiłek codziennie 12:00–14:00',                  54.3610, 18.6500, 'Food Point'),
  ('Park Kolberga',        'Skupisko osób w kryzysie, szczególnie w weekendy',       54.3490, 18.6410, 'Risk Zone'),
  ('Punkt przy Biedronce', 'Regularne spotkania zespołu w każdy wtorek',             54.3555, 18.6460, 'Meeting Point'),
  ('Poczekalnia SKM',      'Osoby nocujące w budynku stacji',                        54.3580, 18.6420, 'Hotspot'),
  ('Ogrzewalnia Caritas',  'Dzienna ogrzewalnia, max 20 osób',                       54.3530, 18.6390, 'Shelter');

-- Visits (pin_id refs match insertion order above: 1–7)
...
-- Streetwork stats
INSERT INTO streetwork_stats (worker_name, month, interactions, new_contacts, interventions, bg_color) VALUES
  ('Anna K.',   '2025-03', 42, 8, 2, '#33A1FF'),
  ('Marek W.',  '2025-03', 35, 5, 1, '#FF5733'),
  ('Tomasz R.', '2025-03', 28, 3, 3, '#28A745'),
  ('Anna K.',   '2025-04', 38, 6, 0, '#33A1FF'),
  ('Marek W.',  '2025-04', 41, 9, 2, '#FF5733'),
  ('Tomasz R.', '2025-04', 33, 4, 1, '#28A745');
...
-- Users — password is "changeme" hashed as SHA-256
